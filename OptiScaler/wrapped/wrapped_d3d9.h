...
class WrappedIDirect3D9Ex final : public IDirect3D9Ex
{
  public:
    WrappedIDirect3D9Ex(IDirect3D9* real);
    virtual ~WrappedIDirect3D9Ex();
  ...
  private:
    IDirect3D9* _real = nullptr;
    IDirect3D9Ex* _realEx = nullptr;
    LONG _refcount = 1;
};
